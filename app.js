class Game {
    ...
    * Display score
    ...
    showGrade(score) {
        ...
        else if(score > 25) return "Você é brabo";
        else if(score > 20) return "Perfeito";
        else if(score > 15) return "Ótimo!";
        else if(score > 13) return "Boa!";
        else if(score > 10) return "Bom trabalho!";
        else if(score > 5) return "Sério?";
        else return "Perdeu...";
    }
